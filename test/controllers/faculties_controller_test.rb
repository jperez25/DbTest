...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { commitee: @faculty.commitee, name: @faculty.name, position: @faculty.position } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { commitee: @faculty.commitee, name: @faculty.name, position: @faculty.position } }
